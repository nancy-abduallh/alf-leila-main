...
export default function TableCheckout() {
    ...
    if (!session) {
        return (
            <main className="bg-table-dark min-h-screen pt-[72px] flex items-center justify-center px-6 text-center">
                <div>
                    <h1 className="font-display text-cream text-2xl mb-3">No table selected</h1>
                    <p className="text-cream/50 text-sm mb-6">
                        Please scan the QR code on your table to start a dine-in order.
                    </p>
                    <button
        ...
        return (
            <main className="bg-table-dark min-h-screen pt-[72px] flex items-center justify-center px-6">
                <div className="text-center max-w-sm">
                    <h1 className="font-display text-cream text-2xl mb-3">Sign in to order</h1>
                    <p className="text-cream/50 text-sm mb-6">
                        Please sign in so we can send your order to the kitchen for Table {session.tableNumber}.
                    </p>
        ...
        <main className="bg-table-dark min-h-screen pt-[72px]">
            <div className="max-w-[800px] mx-auto px-6 lg:px-12 py-16 lg:py-24">
                <div className="flex items-center gap-2 mb-2 text-gold-primary">
                    ...
                    <span className="text-sm tracking-[0.1em] uppercase">Dine-in Order</span>
                </div>
                <h1 className="font-display text-cream text-2xl lg:text-3xl mb-8">
                ...
                <div className="bg-table-mid border border-gold-primary/10 rounded-lg p-5 mb-8">
                    <label className="text-cream/60 text-sm mb-1.5 block">Notes for the kitchen</label>
                    <textarea
                        rows={3}
                        value={notes}
                ...
                <div className="bg-gold-primary/5 border border-gold-primary/20 rounded-lg p-4 mb-8 text-sm text-cream/60">
                    After you place this order you&apos;ll have{" "}
                    <span className="text-gold-primary font-medium">5 minutes</span> to edit it before it&apos;s
                    sent to the kitchen. Everyone at Table {session.tableNumber} who orders in that window will be
                    prepared together.
                </div>
